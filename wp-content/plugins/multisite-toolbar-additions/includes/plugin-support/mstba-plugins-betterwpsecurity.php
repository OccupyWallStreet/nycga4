...
$mstba_tb_items[ $mstba_bwps_pre_id . '_betterwpsecurity' ] = array(
	...
	'meta'   => array( 'target' => '', 'title' => _x( 'Better WP Security - Dashboard', 'Translators: For the tooltip', 'multisite-toolbar-additions' ) )
);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_adminuser' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'Admin User', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_awaymode' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'Away Mode', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_banusers' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'Ban Users', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_contentdirectory' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'Content Directory', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_dbbackup' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'Database Backup', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_dbprefix' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'Database Prefix', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_hidebackend' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'Hide Backend', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_detection' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'Intrusion Detection', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_loginlimits' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'Login Limits', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_ssl' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'SSL/ HTTPS', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ $mstba_bwps_pre_id . '_bwps_systemtweaks' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'System Tweaks', 'multisite-toolbar-additions' ) )
	);
