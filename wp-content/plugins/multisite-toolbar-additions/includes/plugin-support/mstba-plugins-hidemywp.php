...
if ( is_super_admin()
	...
	$mstba_tb_items[ 'networkext_hidemywp' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => _x( 'Hide My WP - Security & Branding Settings', 'Translators: For the tooltip', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ 'networkext_hidemywp_general' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'General Settings', 'multisite-toolbar-additions' ) )
	);
	...
	$mstba_tb_items[ 'networkext_hidemywp_permalinks' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => __( 'Permalinks & URLs', 'multisite-toolbar-additions' ) )
	);
