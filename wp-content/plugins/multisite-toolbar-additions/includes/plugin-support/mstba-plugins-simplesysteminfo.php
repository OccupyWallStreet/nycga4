...
if ( is_multisite() && current_user_can( 'manage_network' ) ) {
	...
	$mstba_tb_items[ 'networkext_simplesystinfo' ] = array(
		...
		'href'   => network_admin_url( 'settings.php?page=simple-system-info' ),
		'meta'   => array( 'target' => '', 'title' => _x( 'Network System Info - Overview', 'Translators: For the tooltip', 'multisite-toolbar-additions' ) )
	);
		...
		$mstba_tb_items[ 'networkext_simplesystinfo_wordpress' ] = array(
			...
			'href'   => network_admin_url( 'settings.php?page=simple-system-info&tab=wordpress' ),
			'meta'   => array( 'target' => '', 'title' => __( 'WordPress Install Info', 'multisite-toolbar-additions' ) )
		);

		$mstba_tb_items[ 'networkext_simplesystinfo_database' ] = array(
			'parent' => $networkext_simplesystinfo,
			'title'  => __( 'Database', 'multisite-toolbar-additions' ),
			'href'   => network_admin_url( 'settings.php?page=simple-system-info&tab=database' ),
			'meta'   => array( 'target' => '', 'title' => __( 'Database', 'multisite-toolbar-additions' ) )
		);

		$mstba_tb_items[ 'networkext_simplesystinfo_php' ] = array(
			'parent' => $networkext_simplesystinfo,
			'title'  => __( 'PHP Info', 'multisite-toolbar-additions' ),
			'href'   => network_admin_url( 'settings.php?page=simple-system-info&tab=phpinfo' ),
			'meta'   => array( 'target' => '', 'title' => __( 'PHP Info', 'multisite-toolbar-additions' ) )
		);

		$mstba_tb_items[ 'networkext_simplesystinfo_mysql' ] = array(
			'parent' => $networkext_simplesystinfo,
			'title'  => __( 'MySQL Info', 'multisite-toolbar-additions' ),
			'href'   => network_admin_url( 'settings.php?page=simple-system-info&tab=mysqlinfo' ),
			'meta'   => array( 'target' => '', 'title' => __( 'MySQL Info', 'multisite-toolbar-additions' ) )
		);

		$mstba_tb_items[ 'networkext_simplesystinfo_about' ] = array(
			'parent' => $networkext_simplesystinfo,
			'title'  => __( 'About', 'multisite-toolbar-additions' ),
			'href'   => network_admin_url( 'settings.php?page=simple-system-info&tab=about' ),
		...
		$mstba_tb_items[ 'networkext_simplesystinfo_support' ] = array(
			...
			'href'   => 'http://www.millan.rs/forums/forum/smart/simple-system-info/',
...
if ( current_user_can( 'activate_plugins' ) ) {
	...
	$mstba_tb_items[ 'siteext_simplesystinfo' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => _x( 'Site System Info - Overview', 'Translators: For the tooltip', 'multisite-toolbar-additions' ) )
	);
