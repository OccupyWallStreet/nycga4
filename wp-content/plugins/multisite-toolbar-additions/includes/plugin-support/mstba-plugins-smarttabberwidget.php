 ...
 */
	...
	$mstba_tb_items[ 'siteext_smarttabberwidget' ] = array(
		...
		'meta'   => array( 'target' => '', 'title' => _x( 'Smart Tabber Widget - Settings', 'Translators: For the tooltip', 'multisite-toolbar-additions' ) )
	);
		...
		$mstba_tb_items[ 'siteext_smarttabberwidget_stylebuilder' ] = array(
			...
			'meta'   => array( 'target' => '', 'title' => __( 'Style Builder', 'multisite-toolbar-additions' ) )
		);
		...
		$mstba_tb_items[ 'siteext_smarttabberwidget_addstyle' ] = array(
			...
			'meta'   => array( 'target' => '', 'title' => __( 'Create new Style', 'multisite-toolbar-additions' ) )
		);
		...
		$mstba_tb_items[ 'siteext_smarttabberwidget_exportimport' ] = array(
			...
			'meta'   => array( 'target' => '', 'title' => __( 'Export/ Import', 'multisite-toolbar-additions' ) )
		);
		...
		$mstba_tb_items[ 'siteext_smarttabberwidget_support' ] = array(
			...
			'href'   => esc_url( 'http://www.millan.rs/forums/forum/smart/smart-tabber-widget/' ),
