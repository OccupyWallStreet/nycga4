...
class Appointments_Widget_Monthly_Calendar extends Appointments_Widget_Helper {
	...
	function Appointments_Widget_Monthly_Calendar() {
		...
		$widget_ops = array( 'description' => __( 'A montly calendar that redirects user to the selected appointment page when a free day is clicked. Use several instances to show several months and set "Months to add to current month" as required, e.g. 0 for the first instance, 1 for the second one, and so on.', 'appointments') );
