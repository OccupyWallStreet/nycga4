...
== Description ==
BuddyPress Group Tasks Management (BP GTM) System helps you to control the development process using tasks and subtasks that correspond to some projects, tags and categories. Responsible people can be chosen, everything can be discussed.

= Important notes =
* If you are upgrading to v1.0 from v0.9.6 - PLEASE MAKE SURE YOU IMPORTED ALL USERS ON GTM ADMIN PAGE JUST AFTER UPGRADE!!!
* After upgrading to v1.0 from v0.9.6 you will need to save some values (e.g. Hide/Display block, Labels)
...
* and lots of other unique features
