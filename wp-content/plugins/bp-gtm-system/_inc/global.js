jQuery(document).ready(function() {
    ...
    if(jQuery.fn.datepicker){
        jQuery("#project_deadline").datepicker(jQuery.datepicker.regional[bp_gtm_strings.lang]);
        jQuery("#task_deadline").datepicker(jQuery.datepicker.regional[bp_gtm_strings.lang]);
    }
    ...
    jQuery('#member-list li').click(function(){
    ...
    jQuery('#member-list select').click(function(e){
        e.stopPropagation();
    });
