...
<ul id="topic-post-list" class="item-list">
   <li id="post-0" class="">
      ...
      <div class="admin-links">
         ...
         <a href="" title="<?php _e( 'Permalink to project description', 'bp_gtm' ) ?>">#</a>
      </div>
   </li>
</ul>
...
<div class="pagination no-ajax">
   <div id="post-count" class="pag-count">
    ...
    <div class="pagination-links" id="topic-pag">
        <p><?php
            _e( 'Deadline', 'bp_gtm' ); echo ': '.bp_gtm_get_format_date( $project['0']->deadline ) ; ?> |
            <?php
   ...
   <ul id="topic-post-list" class="item-list discussions">
    ...
    <?php if (bp_gtm_check_access('discuss_create')) { ?>
        <div id="post-topic-reply">
           ...
           <?php do_action('bp_gtm_discuss_new_reply_after') ?>
