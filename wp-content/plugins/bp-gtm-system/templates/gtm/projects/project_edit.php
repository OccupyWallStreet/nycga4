...
<label for="project_deadline">* <?php _e('Project Deadline', 'bp_gtm'); ?> [yyyy-mm-dd]</label>
<input type="text" name="project_deadline" id="project_deadline" value="<?php echo date('Y-m-d', strtotime($project[0]->deadline)) ?>" readonly="readonly"/>
<div>
    <div class="float">
...
<?php do_action('bp_after_gtm_project_create'); ?>
